...
class MirageStockWidget : AppWidgetProvider() {

    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        super.onUpdate(context, appWidgetManager, appWidgetIds)
        appWidgetIds.forEach { appWidgetId ->
            updateWidget(context, appWidgetManager, appWidgetId, R.layout.widget_mirage_stock)
        }
    }
    ...
    private fun updateWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int, widgetLayoutId: Int) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val data = fetchData("https://example.com/mirage_stock")
            withContext(Dispatchers.Main) {
                // Aktualizacja widoków widgeta na podstawie pobranych danych
                views.setTextViewText(R.id.widget_mirage_stock_title, data)
        ...
        views.setOnClickPendingIntent(R.id.widget_mirage_stock_title, pendingIntent)
